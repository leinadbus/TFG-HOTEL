...
<body>
    ...
    <div id="areaImprimir" class="areaImprimir">
        ...
        <p>Nombre: <?php echo $arrayCliente['nombre'] . " " . $arrayCliente['primerApellido'] ." " . $arrayCliente['segundoApellido'] ?></p>

        <h5>Habitación reservada: </h5>
        <?php 
      echo $habitacion[0]['cod_estancia']; 
        ?>
        ...
        <h5>Precio total: </h5>
        <p><?=$arrayRecuperaCarrito['precioFinal']?>€</p>
